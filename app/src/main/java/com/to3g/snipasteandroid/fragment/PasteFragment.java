...
/**
 * 文字贴图：两个 Tab（文字 / 图片）。原基于 QMUI TabSegment，现改用 Material TabLayout + ViewPager。
 */
...
public class PasteFragment extends BaseFragment {
    ...
    private PagerAdapter mPagerAdapter = new PagerAdapter() {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            return page == ContentPage.Item1
                    ? getString(R.string.pasteSegment_tab_text)
                    : getString(R.string.pasteSegment_tab_picture);
        }
    };
    ...
    private View getPageView(ContentPage page) {
        ...
        if (view == null) {
            if (page == ContentPage.Item1) {
                ...
                view = inflater.inflate(R.layout.text_paste_page_view, null);
            } else {
    ...
    public void onResume() {
        ...
        Log.d("PasteFragment", "onResume: " + content);
        if (content != null) {
            LayoutInflater inflater = (LayoutInflater) requireContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View page = mPageMap.get(ContentPage.Item1);
            if (page != null) {
                android.widget.EditText editText = page.findViewById(R.id.editText);
                if (editText != null) {
